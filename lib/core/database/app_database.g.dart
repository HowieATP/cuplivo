...
class $DirectorMessageRowsTable extends DirectorMessageRows
    with TableInfo<$DirectorMessageRowsTable, DirectorMessageRow> {
  @override
  final GeneratedDatabase attachedDatabase;
  final String? _alias;
  $DirectorMessageRowsTable(this.attachedDatabase, [this._alias]);
  static const VerificationMeta _idMeta = const VerificationMeta('id');
  @override
  late final GeneratedColumn<String> id = GeneratedColumn<String>(
    'id',
  ...
  @override
  String get actualTableName => $name;
  static const String $name = 'director_message_rows';
  @override
  VerificationContext validateIntegrity(
    Insertable<DirectorMessageRow> instance, {
    bool isInserting = false,
  }) {
    final context = VerificationContext();
    final data = instance.toColumns(true);
  ...
  Set<GeneratedColumn> get $primaryKey => {id};
  @override
  DirectorMessageRow map(Map<String, dynamic> data, {String? tablePrefix}) {
    final effectivePrefix = tablePrefix != null ? '$tablePrefix.' : '';
    return DirectorMessageRow(
      id: attachedDatabase.typeMapping.read(
        DriftSqlType.string,
        data['${effectivePrefix}id'],
      )!,
  ...
  @override
  $DirectorMessageRowsTable createAlias(String alias) {
    return $DirectorMessageRowsTable(attachedDatabase, alias);
  }
}

class DirectorMessageRow extends DataClass
    implements Insertable<DirectorMessageRow> {
  final String id;
  final String groupChatId;
  final String role;
  final String content;
  ...
  DirectorMessageRowsCompanion toCompanion(bool nullToAbsent) {
    return DirectorMessageRowsCompanion(
      id: Value(id),
      groupChatId: Value(groupChatId),
      role: Value(role),
      content: Value(content),
  ...
  factory DirectorMessageRow.fromJson(
    Map<String, dynamic> json, {
    ValueSerializer? serializer,
  }) {
    serializer ??= driftRuntimeOptions.defaultSerializer;
  ...
  DirectorMessageRow copyWithCompanion(DirectorMessageRowsCompanion data) {
    return DirectorMessageRow(
      id: data.id.present ? data.id.value : this.id,
      groupChatId: data.groupChatId.present
          ? data.groupChatId.value
  ...
  @override
  String toString() {
    return (StringBuffer('DirectorMessageRow(')
          ..write('id: $id, ')
          ..write('groupChatId: $groupChatId, ')
          ..write('role: $role, ')
          ..write('content: $content, ')
...
class DirectorMessageRowsCompanion extends UpdateCompanion<DirectorMessageRow> {
  final Value<String> id;
  final Value<String> groupChatId;
  final Value<String> role;
  final Value<String> content;
  ...
  final Value<int> rowid;
  const DirectorMessageRowsCompanion({
    this.id = const Value.absent(),
    this.groupChatId = const Value.absent(),
    this.role = const Value.absent(),
    this.content = const Value.absent(),
  ...
  DirectorMessageRowsCompanion.insert({
    required String id,
    required String groupChatId,
    required String role,
    required String content,
    ...
    this.rowid = const Value.absent(),
       ...
       messageOrder = Value(messageOrder),
       createdAt = Value(createdAt);
  static Insertable<DirectorMessageRow> custom({
    Expression<String>? id,
    Expression<String>? groupChatId,
    Expression<String>? role,
    Expression<String>? content,
  ...
  DirectorMessageRowsCompanion copyWith({
    Value<String>? id,
    Value<String>? groupChatId,
    Value<String>? role,
    Value<String>? content,
  ...
  @override
  String toString() {
    return (StringBuffer('DirectorMessageRowsCompanion(')
          ..write('id: $id, ')
          ..write('groupChatId: $groupChatId, ')
          ..write('role: $role, ')
          ..write('content: $content, ')
...
abstract class _$AppDatabase extends GeneratedDatabase {
  ...
  late final $DirectorMessageRowsTable directorMessageRows =
      $DirectorMessageRowsTable(this);
  ...
  late final Index idxDirectorMessagesGroupOrder = Index(
    'idx_director_messages_group_order',
    'CREATE INDEX idx_director_messages_group_order ON director_message_rows (group_chat_id, message_order)',
  );
  @override
  ...
  StreamQueryUpdateRules get streamUpdateRules => const StreamQueryUpdateRules([
    ...
    WritePropagation(
      ...
      result: [TableUpdate('director_message_rows', kind: UpdateKind.delete)],
    ),
  ]);
}
...
final class $$GroupChatRowsTableReferences
  ...
  static MultiTypedResultKey<
    $DirectorMessageRowsTable,
    List<DirectorMessageRow>
  >
  _directorMessageRowsRefsTable(_$AppDatabase db) =>
      MultiTypedResultKey.fromTable(
        db.directorMessageRows,
        aliasName: 'group_chat_rows__id__director_message_rows__group_chat_id',
      );

  $$DirectorMessageRowsTableProcessedTableManager get directorMessageRowsRefs {
    final manager = $$DirectorMessageRowsTableTableManager(
      $_db,
      $_db.directorMessageRows,
    ).filter((f) => f.groupChatId.id.sqlEquals($_itemColumn<String>('id')!));

    final cache = $_typedResult.readTableOrNull(
      _directorMessageRowsRefsTable($_db),
    );
    return ProcessedTableManager(
      manager.$state.copyWith(prefetchedData: cache),
    );
...
class $$GroupChatRowsTableFilterComposer
  ...
  Expression<bool> directorMessageRowsRefs(
    Expression<bool> Function($$DirectorMessageRowsTableFilterComposer f) f,
  ) {
    final $$DirectorMessageRowsTableFilterComposer composer = $composerBuilder(
      composer: this,
      getCurrentColumn: (t) => t.id,
      referencedTable: $db.directorMessageRows,
      getReferencedColumn: (t) => t.groupChatId,
      builder:
          (
            joinBuilder, {
            $addJoinBuilderToRootComposer,
            $removeJoinBuilderFromRootComposer,
          }) => $$DirectorMessageRowsTableFilterComposer(
            $db: $db,
            $table: $db.directorMessageRows,
            $addJoinBuilderToRootComposer: $addJoinBuilderToRootComposer,
            joinBuilder: joinBuilder,
            $removeJoinBuilderFromRootComposer:
                $removeJoinBuilderFromRootComposer,
...
class $$GroupChatRowsTableAnnotationComposer
  ...
  Expression<T> directorMessageRowsRefs<T extends Object>(
    Expression<T> Function($$DirectorMessageRowsTableAnnotationComposer a) f,
  ) {
    final $$DirectorMessageRowsTableAnnotationComposer composer =
        $composerBuilder(
          composer: this,
          getCurrentColumn: (t) => t.id,
          referencedTable: $db.directorMessageRows,
          ...
          builder:
              (
                ...
                $addJoinBuilderToRootComposer,
                $removeJoinBuilderFromRootComposer,
              }) => $$DirectorMessageRowsTableAnnotationComposer(
                $db: $db,
                $table: $db.directorMessageRows,
                $addJoinBuilderToRootComposer: $addJoinBuilderToRootComposer,
                joinBuilder: joinBuilder,
    ...
    : super(
        TableManagerState(
          ...
          prefetchHooksCallback:
              ({
                conversationId = false,
                groupChatMemberRowsRefs = false,
                directorMessageRowsRefs = false,
              }) {
                return PrefetchHooks(
                  db: db,
                  explicitlyWatchedTables: [
                    if (groupChatMemberRowsRefs) db.groupChatMemberRows,
                    if (directorMessageRowsRefs) db.directorMessageRows,
                  ],
                  addJoins:
                      <
                        T extends TableManagerState<
                    ...
                    return [
                      ...
                      if (directorMessageRowsRefs)
                        ...
                        >(
                          currentTable: table,
                          referencedTable: $$GroupChatRowsTableReferences
                              ._directorMessageRowsRefsTable(db),
                          managerFromTypedResult: (p0) =>
                              $$GroupChatRowsTableReferences(
                                db,
                                table,
                                p0,
                              ).directorMessageRowsRefs,
                          referencedItemsForCurrentItem:
                              (item, referencedItems) => referencedItems.where(
                                (e) => e.groupChatId == item.id,
                              ),
...
typedef $$GroupChatMemberRowsTableProcessedTableManager =
    ProcessedTableManager<
      ...
      PrefetchHooks Function({bool groupChatId})
    >;
typedef $$DirectorMessageRowsTableCreateCompanionBuilder =
    DirectorMessageRowsCompanion Function({
      required String id,
      required String groupChatId,
      required String role,
      required String content,
...
typedef $$DirectorMessageRowsTableUpdateCompanionBuilder =
    DirectorMessageRowsCompanion Function({
      Value<String> id,
      Value<String> groupChatId,
      Value<String> role,
...
final class $$DirectorMessageRowsTableReferences
    extends
        BaseReferences<
          _$AppDatabase,
          $DirectorMessageRowsTable,
          DirectorMessageRow
        > {
  $$DirectorMessageRowsTableReferences(
    super.$_db,
    super.$_table,
    super.$_typedResult,
  );

  static $GroupChatRowsTable _groupChatIdTable(_$AppDatabase db) => db
      .groupChatRows
      .createAlias('director_message_rows__group_chat_id__group_chat_rows__id');
...
class $$DirectorMessageRowsTableFilterComposer
    extends Composer<_$AppDatabase, $DirectorMessageRowsTable> {
  $$DirectorMessageRowsTableFilterComposer({
    required super.$db,
    required super.$table,
    super.joinBuilder,
...
class $$DirectorMessageRowsTableOrderingComposer
    extends Composer<_$AppDatabase, $DirectorMessageRowsTable> {
  $$DirectorMessageRowsTableOrderingComposer({
    required super.$db,
    required super.$table,
    super.joinBuilder,
    super.$addJoinBuilderToRootComposer,
...
class $$DirectorMessageRowsTableAnnotationComposer
    extends Composer<_$AppDatabase, $DirectorMessageRowsTable> {
  $$DirectorMessageRowsTableAnnotationComposer({
    required super.$db,
    required super.$table,
...
class $$DirectorMessageRowsTableTableManager
    extends
        RootTableManager<
          _$AppDatabase,
          $DirectorMessageRowsTable,
          ...
          $$DirectorMessageRowsTableOrderingComposer,
          $$DirectorMessageRowsTableAnnotationComposer,
          $$DirectorMessageRowsTableCreateCompanionBuilder,
          $$DirectorMessageRowsTableUpdateCompanionBuilder,
          (DirectorMessageRow, $$DirectorMessageRowsTableReferences),
          DirectorMessageRow,
          PrefetchHooks Function({bool groupChatId})
        > {
  $$DirectorMessageRowsTableTableManager(
    _$AppDatabase db,
    $DirectorMessageRowsTable table,
  ) : super(
        TableManagerState(
          db: db,
          table: table,
          createFilteringComposer: () =>
              $$DirectorMessageRowsTableFilterComposer($db: db, $table: table),
          createOrderingComposer: () =>
              $$DirectorMessageRowsTableOrderingComposer(
                $db: db,
                $table: table,
          ...
          withReferenceMapper: (p0) => p0
              .map(
                (e) => (
                  e.readTable(table),
                  $$DirectorMessageRowsTableReferences(db, table, e),
                ),
              )
              .toList(),
          prefetchHooksCallback: ({groupChatId = false}) {
...
typedef $$DirectorMessageRowsTableProcessedTableManager =
    ProcessedTableManager<
      _$AppDatabase,
      $DirectorMessageRowsTable,
      DirectorMessageRow,
...
class $AppDatabaseManager {
  ...
  $$DirectorMessageRowsTableTableManager get directorMessageRows =>
      $$DirectorMessageRowsTableTableManager(_db, _db.directorMessageRows);
}
