...
class SettingsProvider extends ChangeNotifier {
  ...
  static const String _trashCapMbKey = 'trash_cap_mb_v1';
  ...
  Future<_MigrationResult> _migrateEmbeddingModelOverrides(
    ...
    try {
      ...
      for (final entry in nextProviderConfigs.entries) {
  ...
  Future<void> _load() async {
    ...
    if (cfgStr != null && cfgStr.isNotEmpty) {
      try {
        ...
        final decoded = <String, ProviderConfig>{};
        for (final entry in raw.entries) {
          decoded[entry.key] = ProviderConfig.fromJson(
    ...
    try {
      ...
      if (providerConfigsLoaded &&
        ...
        if (!prefs.containsKey(_providerConfigsBackupKey)) {
          ...
          for (final entry in _providerConfigs.entries) {
            backup[entry.key] = entry.value.toJson();
          }
...
DO NOT GIVE ANSWERS OR DO HOMEWORK FOR THE USER. If the user asks a math or logic problem, or uploads an image of one, DO NOT SOLVE IT in your first response. Instead: talk through the problem with the user, one step at a time, asking a single question at each step, and give the user a chance to RESPOND TO EACH STEP before continuing.''';
  ...
  // Trash (deleted records) cap in MB. 0 = unlimited.
  int _trashCapMb = 10;
  int get trashCapMb => _trashCapMb;
  Future<void> setTrashCapMb(int v) async {
  ...
  SettingsProvider copyWith({
    ...
    copy._iosBackgroundNotificationsEnabled =
        _iosBackgroundNotificationsEnabled;
    copy._iosKeepAliveEnabled = _iosKeepAliveEnabled;
    copy._iosSilentAudioKeepAliveEnabled = _iosSilentAudioKeepAliveEnabled;
    copy._iosLocationKeepAliveEnabled = _iosLocationKeepAliveEnabled;
    copy._iosLiveActivityPrivacyMode = _iosLiveActivityPrivacyMode;
