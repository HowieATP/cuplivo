...
class SearchServiceUsageService {
  ...
  static Future<SearchServiceUsageInfo> fetch(
    ...
    // Shared per-category logging instance; closing it is a no-op on the
    // base client, so the ownsClient cleanup below stays safe.
    final baseClient = client ?? LoggingHttpClient.of(LoggingCategory.search);
